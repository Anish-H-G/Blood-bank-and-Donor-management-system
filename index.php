            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%"><li>Check the blood stocks online. If you know your blood type, it's a great idea to check the blood stocks before your visit.</li> <li> Drink lots of water.</li>                  
    <li>Eat a salty snack.</li>
    <li>Wear loose, comfortable clothing.</li>
   <li> Avoid heavy lifting and vigorous exercise.</li>
   <li> Share your good deed. </li> </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
...
<li>AB positive or AB negative.</li>
                ...
                <b>Leafy greens, dairy products, liver, potatoes, banana, cereals, orange juice</b>
                </p>
            </div>
            <div class="col-lg-6">
